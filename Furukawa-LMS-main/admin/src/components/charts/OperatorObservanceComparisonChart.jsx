...
import { useGetOperatorObservanceStatusQuery } from '@/Redux/AllApi/AdminHomeApi';
...
const OperatorObservanceComparisonChart = ({ departments: departmentsProp } = {}) => {
    ...
    const { data, isLoading, error } = useGetOperatorObservanceStatusQuery({
        groupBy: timeframe,
        startDate,
        endDate,
            ...
            <CardHeader className="pb-4">
                <div className="space-y-1">
                    <CardTitle className="flex items-center gap-2 text-lg">
                        ...
                        {t('charts.operatorObservanceComparison')}
                    </CardTitle>
                    <CardDescription>
                        {t('charts.operatorObservanceComparisonDesc')}
                    </CardDescription>
                </div>
            ...
            <CardContent>
                {isLoading ? (
                    ...
                    <div style={{ height: emptyStateHeight }} className="flex flex-col items-center justify-center text-red-500 gap-2">
                        <p className="text-sm font-semibold">{t('charts.failedToLoadOperatorObservance')}</p>
                    </div>
                ) : !hasAnyData ? (
                    <div style={{ height: emptyStateHeight }} className="flex flex-col items-center justify-center text-gray-400 bg-gray-50/50 rounded-xl border border-dashed gap-2">
                        ...
                        <p className="text-sm font-medium">{t('charts.noOperatorObservanceData')}</p>
...
export default OperatorObservanceComparisonChart;
