...
import { useGetThreeDayMonitoringStatusQuery } from '@/Redux/AllApi/AdminHomeApi';
...
import { IconClipboardList, IconCalendar, IconRefresh, IconChevronDown } from "@tabler/icons-react";
...
const ThreeDayMonitoringComparisonChart = ({ departments: departmentsProp } = {}) => {
    ...
    const { data, isLoading, error } = useGetThreeDayMonitoringStatusQuery({
        groupBy: timeframe,
        startDate,
        endDate,
            ...
            <CardHeader className="pb-4">
                <div className="space-y-1">
                    <CardTitle className="flex items-center gap-2 text-lg">
                        ...
                        {t('charts.threeDayMonitoringComparison')}
                    </CardTitle>
                    <CardDescription>
                        {t('charts.threeDayMonitoringComparisonDesc')}
                    </CardDescription>
                </div>
            ...
            <CardContent>
                {isLoading ? (
                    ...
                    <div style={{ height: emptyStateHeight }} className="flex flex-col items-center justify-center text-red-500 gap-2">
                        <p className="text-sm font-semibold">{t('charts.failedToLoadThreeDay')}</p>
                    </div>
                ) : !hasAnyData ? (
                    <div style={{ height: emptyStateHeight }} className="flex flex-col items-center justify-center text-gray-400 bg-gray-50/50 rounded-xl border border-dashed gap-2">
                        ...
                        <p className="text-sm font-medium">{t('charts.noThreeDayData')}</p>
...
export default ThreeDayMonitoringComparisonChart;
